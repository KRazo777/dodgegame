namespace DodgeGame.Common.Packets
{
    public static class PacketIds
    {
        public static class Serverbound
        {
            ...
            public const ushort JoinGameRequest = 4;
            public const ushort Movement = 5;
        }
        ...
        public static class Clientbound
        {
            ...
            public const ushort Pong = 1003;
            public const ushort JoinGameConfirmed = 1004;
            public const ushort PlayerDetails = 1005;
            public const ushort SpawnPlayer = 1006;
            public const ushort Movement = 1007;
        }
    }
}
